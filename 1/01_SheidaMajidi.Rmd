...
I am analyzing my LinkedIn connections to understand my network better, focusing on the distribution of connections across different employers and the network's structure.
...
Starting with loading my LinkedIn connections data and perform initial cleaning and examination of the data.

```{r data-loading}
file_path = "/Users/sheidamajidi/Desktop/Winter2024/Winter2024-2/ORGB672/Exercises/1/Connections.csv"
...
For a better visualizations, I want to create a frequency table of the companies and visualize the top 15 companies with the most connections
